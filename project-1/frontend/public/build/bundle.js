...
var app = (function () {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (default_slot) default_slot.c();
    			set_attributes(div, div_data);
    			add_location(div, file$8, 19, 0, 362);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$9, 24, 20, 379);
    		},
    		m: function mount(target, anchor) {
    ...
    class Profile extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { displayName: 0, photoURL: 1, uid: 2 });
    ...
    // (101:0) {#if localStorage.getItem("uid")}
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$a, 112, 0, 2381);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(101:0) {#if localStorage.getItem(\\\"uid\\\")}",
    		ctx
    	});
    ...
    function create_default_slot_4$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$a, 121, 0, 2533);
    			attr_dev(input1, "id", "email");
    			attr_dev(input1, "name", "email");
    			attr_dev(input1, "placeholder", "email");
    			input1.required = true;
    			add_location(input1, file$a, 122, 0, 2604);
    			attr_dev(input2, "id", "password");
    			attr_dev(input2, "name", "password");
    			attr_dev(input2, "placeholder", "password");
    			attr_dev(input2, "type", "password");
    			input2.required = true;
    			add_location(input2, file$a, 123, 0, 2667);
    			attr_dev(button0, "class", "log-out-btn");
    			add_location(button0, file$a, 124, 0, 2754);
    			attr_dev(button1, "class", "log-out-btn");
    			add_location(button1, file$a, 125, 0, 2815);
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			hr = element("hr");
    			add_location(hr, file$a, 108, 4, 2362);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$b, 10, 2, 143);
    			add_location(head, file$b, 9, 0, 134);
    			add_location(main, file$b, 12, 0, 255);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
